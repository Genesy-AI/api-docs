...
You can create webhook subscriptions from [the API](https://docs.genesy.ai/api-reference/webhooks/create-webhook-subscription) or from the [dashboard](https://app.genesy.ai/api-access).
