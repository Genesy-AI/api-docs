...
<CardGroup cols={2}>
  <Card title="Health Endpoint" icon="heart-pulse" href="/api-reference/custom-crm-interface#health-endpoint">
    A `GET /health` endpoint for connection validation
  </Card>
  <Card title="Tasks API" icon="list-check" href="/api-reference/custom-crm-interface#tasks-endpoints">
    Task CRUD endpoints following our interface specification
  </Card>
</CardGroup>
...
Before connecting, ensure your CRM implements the required interface. See the [Custom CRM Interface Reference](/api-reference/custom-crm-interface) for detailed specifications.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="/api-reference/custom-crm-interface"
  >
    View the detailed API specification your CRM must implement
  </Card>
  <Card
    title="API Reference"
    icon="book"
  ...
  >
    Explore Genesy API endpoints for managing your Custom CRM connection
  </Card>
</CardGroup>
